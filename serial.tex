...
The R$_{free}$/R$_{work}$ quality indicators \cite{Rfree} were calculated for the initial dataset and compared with the same dataset sparsified at 0.8, 1.0, 1.4 and $2.0\sigma$ and subsequently re-densified (Fig. \ref{Rfree}). 

\begin{figure}
\label{Rfree}
\begin{center}
\includegraphics[width=9cm]{fig_Rfree}
\caption{Degradation of R$_{work}$ and R$_{free}$ crystallographic quality indicators on the integral dataset of HEWL+Ga (11k frames), when increasing the levels of sparsification.}
\end{center}
\end{figure}
