...
The quality of peaks extracted with this algorithm is evaluated on a serial-crystallography dataset acquired at the ID30B beamline at the ESRF with an Eiger-4M detector \cite{ssx-Lyso}.
Tiny crystals of Lysozyme were deposited on a membrane and this membrane was scanned in front of the beam.
A fraction of 1000 frames of the complete dataset was processed several times with CrystFEL and 

The ultimate goal is to perform peak-finding as 
