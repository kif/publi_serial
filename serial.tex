...
\aff[b]{EMBL Grenoble \country{France}}
...
A big limitation of this application is that the environment of MX beamlines is extremely specialized towards rotation data collection. %explain more clearly if needed
%\cite{Cheetah2014}
...
The result of this algorithm is compared with "peakfinder8" described in \citeasnoun{Cheetah2014} and interfaced in Python via OnDA \cite{onda}
\subsection{Performances}
