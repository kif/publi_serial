...
\subsection{Influence of the cut-off on the quality of serial-crystallography data}
\label{nicolas}
The influence of the cut-off parameter has been evaluated on the ability to phase a dataset and reconstruct an electron density map. 
This ability was probed with different number of frames in the dataset in order to artificially decrease the anomalous signal strength.
