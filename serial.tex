...
Unlike X-FEL, synchrotron X-ray beam show little bunch to bunch variability and with the the beam being well characterized, those anisotropic correction can be easily taken into account.
...
Intensity is often also be normalized by the incoming flux $I_0$, but since it is independent from the pixel position this correction has no influence.
