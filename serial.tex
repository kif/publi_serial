...
As any lossy compression, the user has still the responsibility of choosing the level under which all data will be lost, which will limit later-on the quality of the results one may extract from those data.  \cite{cc1/2}.
...
\section{Application to peak-finding}
