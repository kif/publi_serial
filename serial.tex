...
We present here a real-time analysis of diffraction images acquired at high frame-rate (925 Hz, ~ 1 kHz) and its application to macromolecular serial crystallography.
...
The strong sensitivity of the indexation rate on the peak-position (<1 pixel) could explain the lower indexation rate of peak position obtained with Jungfrau detector in comparison with the Eiger data described in \ref{quality-pf}.
