...
A big limittion of this application is that the environment of MX beamlines is extremelly specialized towards rotation data collection. %explain more clearly if needed
%\cite{Cheetah2014}
...
The result of this algorithm is compared with the "peakfinder8" described in \cite{Cheetah2014} and interfaced in Python via OnDA \cite{onda}
\subsection{Performances}
