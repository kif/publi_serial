...
The influence of the sparsification and especially of the cut-off parameter has been evaluated along two axis, first of all, monitoring the degradation of quality indicators degradation and then, by checking the ability to phase a dataset from anomalous signal.
...
Those indicatores are compared with the one obtained from the same dataset sparsified at $0.8\sigma$ and $2.0\sigma$ and subsequently re-densified in figure \ref{nicolas_R}.
