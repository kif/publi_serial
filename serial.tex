...
\end{figure}
In figure \ref{peakfinder}, the minimum SNR is 3 with a noise level of 1 since the detector is Poissonian.
Peaks are registered if 4 pixels meet the SNR criterion in a 5x5 pixel patch around the peak.
Those parameters have been tuned to obtain a comparable number of peaks with each algorithm: 287 with pyFAI and 293 with Onda.
This allows to compare the distribution of points as function of
